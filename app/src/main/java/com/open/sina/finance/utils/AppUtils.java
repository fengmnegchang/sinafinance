...
public final class AppUtils {
    ...
    public static String getAppMetaData(String key) {
        if (Utils.getApp() == null || StringUtils.isEmpty(key)) {
            return null;
        }
        ...
        try {
            ...
            if (packageManager != null) {
                ApplicationInfo applicationInfo = packageManager.getApplicationInfo(Utils.getApp().getPackageName(), PackageManager.GET_META_DATA);
