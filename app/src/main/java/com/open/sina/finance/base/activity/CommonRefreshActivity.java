...
public abstract class CommonRefreshActivity <T extends PullToRefreshBase<V>, V extends View> extends CommonTitleBarActivity implements OnHandleRefreshListener<T, V>, PullToRefreshBase.OnRefreshListener2<V>, PullToRefreshBase.OnPullEventListener<V> {
    private T t;//刷新控件
