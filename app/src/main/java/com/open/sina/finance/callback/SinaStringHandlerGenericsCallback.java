...
public abstract class SinaStringHandlerGenericsCallback<T> extends GenericsCallback<T> {

    public Handler weakActivityReferenceHandler;
    public Context mContext;

    public SinaStringHandlerGenericsCallback(Context mContext, IGenericsSerializator serializator, Handler weakActivityReferenceHandler) {
        super(serializator);
...
//        }
    ...
    public void onResponseHeaders(Response response, int id,int which) {
        LogUtils.i("SinaStringHandlerGenericsCallback","onResponse");
//        //headers
