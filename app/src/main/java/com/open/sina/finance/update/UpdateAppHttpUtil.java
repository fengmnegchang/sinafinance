package com.open.sina.finance.update;
    ...
    public void asyncGet(@NonNull String url, @NonNull Map<String, String> params, @NonNull final Callback callBack) {
        OkHttpUtils.get()
                ...
                .execute(new StringCallback() {
                    ...
                    @Override
                    public void onResponse(String response, int id,int which) {
    ...
    public void download(@NonNull String url, @NonNull String path, @NonNull String fileName, @NonNull final FileCallback callback) {
        OkHttpUtils.get()
                ...
                .execute(new FileCallBack(path, fileName) {
                    ...
                    @Override
                    public void onResponse(File response, int id,int which) {
                        callback.onResponse(response);
                    ...
                    public void onBefore(Request request, int id,int which) {
                        super.onBefore(request, id,which);
                        callback.onBefore();
                    }
                });
